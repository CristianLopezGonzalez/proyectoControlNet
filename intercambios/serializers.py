...
from turnos.serializers import AsignacionTardeSerializer
...
class SolicitudIntercambioSerializer(serializers.ModelSerializer):
    ...
    asignacion_origen_detalle = AsignacionTardeSerializer(source='asignacion_origen', read_only=True)
    asignacion_destino_detalle = AsignacionTardeSerializer(source='asignacion_destino', read_only=True)
